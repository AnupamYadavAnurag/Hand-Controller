    ...
    if result.hand_landmarks:
        for hand in result.hand_landmarks:
            ...
            if gesture_hold == HOLD_FRAMES and last_triggered != gesture:
                ...
                if gesture == "1":
                    webbrowser.open_new_tab('https://anupamyadavanurag.github.io')

                elif gesture == "2":
                    webbrowser.open_new_tab('https://github.com/anupamyadavanurag')

                elif gesture == "3":
                    webbrowser.open_new_tab('https://instagram.com/anupamyadavanurag')

                elif gesture == "4":
                    webbrowser.open_new_tab('https://www.linkedin.com/anupamyadavanurag')
